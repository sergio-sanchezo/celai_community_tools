...
from celai_community_tools.providers.base_provider import ToolProvider
from celai_community_tools.auth import Firecrawl
...
def _import_firecrawl() -> Any:
    ...
    try:
        ...
        raise ImportError(
            "Cannot import firecrawl, please install with `pip install firecrawl-py`."
        ) from e
...
class FirecrawlProvider(ToolProvider):
    ...
    def scrape_url(params, ctx):
        ...
        FirecrawlApp = _import_firecrawl()
